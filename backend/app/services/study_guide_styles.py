...
"""Print & screen styles for Ringo HTML study guides (A4-friendly)."""

from app.services.korean_fonts import korean_font_face_css

RINGO_STUDY_GUIDE_CSS = (
    korean_font_face_css()
    + """
...
def wrap_study_guide_html(body: str, title: str) -> str:
...
<body>
  <article class="ringo-study-guide">
    <h1 class="sg-title">{_escape(title)}</h1>
    {body}
  </article>
</body>
</html>"""
